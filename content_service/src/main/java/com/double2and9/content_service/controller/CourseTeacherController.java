...
public class CourseTeacherController {
     ...
     * 添加或修改课程教师
     */
    @Operation(summary = "保存课程教师信息", 
              description = "创建或更新教师信息，同时管理与课程的关联关系")
    @PostMapping
    public ContentResponse<Void> saveCourseTeacher(
            @Parameter(description = "教师信息", required = true)
            @RequestBody @Validated SaveCourseTeacherDTO teacherDTO) {
    ...
    @Operation(summary = "解除教师与课程的关联", 
              description = "解除特定教师与课程的关联关系，如果教师不再关联任何课程则删除教师")
